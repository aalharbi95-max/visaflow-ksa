...
begin
  ...
  loop
    ...
    from jsonb_to_recordset('[
      ...
      {"ord":7,"ar":"اذكر خطأً في عملية موارد بشرية كان قد يؤثر على الموظفين، وكيف صححته ومنعت تكراره؟","en":"Describe an HR process error that could affect employees and how you corrected and prevented recurrence.","kind":"Behavioral","competency":"Controls and accountability","difficulty":"Advanced","weight":14,"seconds":160,"keywords":["containment","root cause","correction","control"],"points":["Protect employees","Root cause","Preventive control"],"guide":{"excellent":"Contains impact, corrects records and installs a preventive control","acceptable":"Corrects and documents the issue","weak":"Hides or shifts blame"},"ideal":"يحتوي الأثر ويصحح البيانات ويبلغ الأطراف ويحلل السبب ويضيف رقابة وقائية.","notes":"Accountability is essential."},
      {"ord":8,"ar":"ما خطة أول 90 يوماً لك إذا انضممت إلى جهة جديدة في هذا الدور؟","en":"What would your first 90-day plan be if you joined a new organization in this role?","kind":"Technical","competency":"Planning","difficulty":"Advanced","weight":10,"seconds":150,"keywords":["30 60 90","stakeholders","baseline","priorities"],"points":["Listen and assess","Prioritize","Deliver and measure"],"guide":{"excellent":"Practical phased plan with stakeholders and measures","acceptable":"Logical priorities and early wins","weak":"Unstructured activity list"},"ideal":"خطة 30-60-90 للاستماع وبناء خط أساس وتحديد الأولويات وتحقيق مكاسب قابلة للقياس.","notes":"Assess prioritization and realism."}
