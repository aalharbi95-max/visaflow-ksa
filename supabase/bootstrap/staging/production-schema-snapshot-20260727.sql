...
\restrict IMBWV4R24er7Id41ulGSCLDDpgsu9NqGz3KuChn4R8asNycIzC90AQD9dXtBB2f
  ...
  IF to_regclass('public.email_logs') IS NOT NULL
    ...
    VALUES (
      ...
      coalesce(
        ...
        'AI Interview Invitation / دعوة مقابلة ذكية'
      ),
...
begin
  ...
  /*
    نسخ جميع بيانات القالب السابق تلقائيًا،
    ثم تغيير بيانات الإصدار الجديد فقط.
  */
  v_template_payload :=
    to_jsonb(v_old)
    || jsonb_build_object(
      ...
      /*
        هذه الحقول NOT NULL في قاعدة البيانات،
        لذلك لا نضع NULL.
      */
  ...
  /*
    نسخ جميع أسئلة القالب السابق بأرقام ID جديدة.
  */
  for v_question in
    select *
    ...
    IF v_existing_session_id IS NOT NULL THEN
      ...
      SELECT
        ...
        jsonb_build_object(
          ...
          'final_decision_note',
            'AI recommendation only — final decision belongs to the company.'
        )
      FROM public.ai_interview_sessions AS s
...
ALTER TABLE public.candidates
    ADD CONSTRAINT candidates_saudi_civil_id_required CHECK (((NOT ((lower(COALESCE(nationality, ''::text)) ~~ '%saudi%'::text) OR (COALESCE(nationality, ''::text) ~~ '%سعود%'::text))) OR ((NULLIF(btrim(COALESCE(civil_id_no, ''::text)), ''::text) IS NOT NULL) AND (civil_id_expiry_date IS NOT NULL)))) NOT VALID;
...
CREATE POLICY secure_agency_score_insert ON public.agency_score_history FOR INSERT TO authenticated WITH CHECK ((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))));
...
CREATE POLICY secure_agency_score_select ON public.agency_score_history FOR SELECT TO authenticated USING (((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))) OR (((public.current_log_actor() ->> 'role'::text) = 'Agency'::text) AND ((agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND (EXISTS ( SELECT 1
   FROM public.agency_company_user_access access
  WHERE (((access.user_id)::text = (public.current_log_actor() ->> 'id'::text)) AND ((access.agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND ((access.company_id)::text = (agency_score_history.company_id)::text) AND (access.status = 'Active'::text)))))));
...
CREATE POLICY secure_ai_agent_audit_insert ON public.ai_agent_audit_logs FOR INSERT TO authenticated WITH CHECK ((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))));
...
CREATE POLICY secure_ai_agent_audit_select ON public.ai_agent_audit_logs FOR SELECT TO authenticated USING ((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))));
...
CREATE POLICY secure_email_log_insert ON public.email_logs FOR INSERT TO authenticated WITH CHECK (((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))) OR (((public.current_log_actor() ->> 'role'::text) = ANY (ARRAY['Platform Owner'::text, 'Platform Accounts User'::text])) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL))));
...
CREATE POLICY secure_email_log_select ON public.email_logs FOR SELECT TO authenticated USING (((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))) OR (((public.current_log_actor() ->> 'role'::text) = ANY (ARRAY['Platform Owner'::text, 'Platform Accounts User'::text])) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL))));
...
CREATE POLICY secure_notification_delete ON public.notification_events FOR DELETE TO authenticated USING ((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))));
...
CREATE POLICY secure_notification_insert ON public.notification_events FOR INSERT TO authenticated WITH CHECK (((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))) OR (((public.current_log_actor() ->> 'role'::text) = 'Agency'::text) AND ((agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND (EXISTS ( SELECT 1
   FROM public.agency_company_user_access access
  WHERE (((access.user_id)::text = (public.current_log_actor() ->> 'id'::text)) AND ((access.agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND ((access.company_id)::text = (notification_events.company_id)::text) AND (access.status = 'Active'::text)))))));
...
CREATE POLICY secure_notification_select ON public.notification_events FOR SELECT TO authenticated USING (((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))) OR (((public.current_log_actor() ->> 'role'::text) = 'Agency'::text) AND ((agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND (EXISTS ( SELECT 1
   FROM public.agency_company_user_access access
  WHERE (((access.user_id)::text = (public.current_log_actor() ->> 'id'::text)) AND ((access.agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND ((access.company_id)::text = (notification_events.company_id)::text) AND (access.status = 'Active'::text))))) OR (((public.current_log_actor() ->> 'role'::text) = ANY (ARRAY['Platform Owner'::text, 'Platform Accounts User'::text])) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL))));
...
CREATE POLICY secure_notification_update ON public.notification_events FOR UPDATE TO authenticated USING (((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))) OR (((public.current_log_actor() ->> 'role'::text) = 'Agency'::text) AND ((agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND (EXISTS ( SELECT 1
   FROM public.agency_company_user_access access
  WHERE (((access.user_id)::text = (public.current_log_actor() ->> 'id'::text)) AND ((access.agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND ((access.company_id)::text = (notification_events.company_id)::text) AND (access.status = 'Active'::text))))))) WITH CHECK (((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))) OR (((public.current_log_actor() ->> 'role'::text) = 'Agency'::text) AND ((agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND (EXISTS ( SELECT 1
   FROM public.agency_company_user_access access
  WHERE (((access.user_id)::text = (public.current_log_actor() ->> 'id'::text)) AND ((access.agency_id)::text = (public.current_log_actor() ->> 'agency_id'::text)) AND ((access.company_id)::text = (notification_events.company_id)::text) AND (access.status = 'Active'::text)))))));
...
CREATE POLICY secure_request_audit_insert ON public.request_audit_logs FOR INSERT TO authenticated WITH CHECK ((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))));
...
CREATE POLICY secure_request_audit_select ON public.request_audit_logs FOR SELECT TO authenticated USING ((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))));
...
CREATE POLICY secure_restore_request_insert ON public.system_restore_requests FOR INSERT TO authenticated WITH CHECK ((((public.current_log_actor() ->> 'role'::text) = 'Platform Owner'::text) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_restore_request_select ON public.system_restore_requests FOR SELECT TO authenticated USING ((((public.current_log_actor() ->> 'role'::text) = 'Platform Owner'::text) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_restore_request_update ON public.system_restore_requests FOR UPDATE TO authenticated USING ((((public.current_log_actor() ->> 'role'::text) = 'Platform Owner'::text) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL))) WITH CHECK ((((public.current_log_actor() ->> 'role'::text) = 'Platform Owner'::text) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_support_ticket_delete ON public.support_tickets FOR DELETE TO authenticated USING ((((public.current_log_actor() ->> 'role'::text) = 'Platform Owner'::text) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_support_ticket_insert ON public.support_tickets FOR INSERT TO authenticated WITH CHECK ((((public.current_log_actor() ->> 'role'::text) = ANY (ARRAY['Platform Owner'::text, 'Platform Support User'::text])) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_support_ticket_select ON public.support_tickets FOR SELECT TO authenticated USING ((((public.current_log_actor() ->> 'role'::text) = ANY (ARRAY['Platform Owner'::text, 'Platform Support User'::text])) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_support_ticket_update ON public.support_tickets FOR UPDATE TO authenticated USING ((((public.current_log_actor() ->> 'role'::text) = ANY (ARRAY['Platform Owner'::text, 'Platform Support User'::text])) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL))) WITH CHECK ((((public.current_log_actor() ->> 'role'::text) = ANY (ARRAY['Platform Owner'::text, 'Platform Support User'::text])) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_system_activity_select ON public.system_activity_logs FOR SELECT TO authenticated USING (((((company_id)::text = (public.current_log_actor() ->> 'company_id'::text)) AND ((public.current_log_actor() ->> 'role'::text) <> ALL (ARRAY['Agency'::text, 'Platform Owner'::text, 'Platform Accounts User'::text, 'Platform Support User'::text]))) OR (((public.current_log_actor() ->> 'role'::text) = ANY (ARRAY['Platform Owner'::text, 'Platform Accounts User'::text])) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL))));
...
CREATE POLICY secure_system_backup_delete ON public.system_backups FOR DELETE TO authenticated USING ((((public.current_log_actor() ->> 'role'::text) = 'Platform Owner'::text) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_system_backup_insert ON public.system_backups FOR INSERT TO authenticated WITH CHECK ((((public.current_log_actor() ->> 'role'::text) = 'Platform Owner'::text) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_system_backup_select ON public.system_backups FOR SELECT TO authenticated USING ((((public.current_log_actor() ->> 'role'::text) = 'Platform Owner'::text) AND ((public.current_log_actor() ->> 'company_id'::text) IS NULL)));
...
CREATE POLICY secure_talent_event_insert_own ON public.talent_candidate_events FOR INSERT TO authenticated WITH CHECK (((auth_user_id = auth.uid()) AND (EXISTS ( SELECT 1
   FROM public.talent_candidates candidate
  WHERE ((candidate.id = talent_candidate_events.candidate_id) AND (candidate.auth_user_id = auth.uid()))))));
...
CREATE POLICY secure_talent_event_select_own ON public.talent_candidate_events FOR SELECT TO authenticated USING ((auth_user_id = auth.uid()));
...
--
-- Name: FUNCTION add_candidates_to_ai_interview_campaign(p_campaign_id uuid, p_candidate_ids text[]); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_agent_emergency_stop(p_company_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_agent_hourly_action_count(p_company_id uuid, p_actor text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_agent_release_lock(p_company_id uuid, p_action_key text, p_status text, p_error_message text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_agent_try_acquire_lock(p_company_id uuid, p_action_key text, p_action_type text, p_related_table text, p_related_id text, p_agency_id uuid, p_cooldown_minutes integer); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_interview_campaign_apply_delivery_settings(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_interview_campaign_candidate_sync_session_trigger(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_interview_campaign_sync_delivery_to_sessions_trigger(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_interview_delivery_preflight(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_interview_enforce_campaign_delivery_on_session(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION ai_interview_sync_linked_session_delivery(p_session_id uuid, p_campaign_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION assign_request_no_before_insert(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION calculate_candidate_technical_score(p_education_score numeric, p_experience_score numeric, p_skills_score numeric, p_certification_score numeric, p_language_score numeric, p_data_completeness_score numeric); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_analysis_jobs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION claim_ai_interview_analysis_job(p_worker_name text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_invitation_jobs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION claim_ai_interview_invitation_jobs(p_limit integer, p_worker text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION complete_ai_interview_analysis_job(p_job_id uuid, p_result jsonb); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION complete_ai_interview_invitation_job(p_job_id uuid, p_message_id text, p_provider text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION create_ai_interview_template_version(p_template_id uuid, p_version_notes text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION create_onboarding_validation_from_candidate(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION current_app_agency_id(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION current_app_company_id(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION current_app_user_agency_id(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION current_app_user_company_id(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION current_app_user_has_role(allowed_roles text[]); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION current_app_user_role(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION current_log_actor(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION enqueue_ai_interview_analysis_on_completion(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION fail_ai_interview_analysis_job(p_job_id uuid, p_error text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION fail_ai_interview_invitation_job(p_job_id uuid, p_error text, p_retry_delay_minutes integer); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION generate_request_no(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_ai_interview_invitation_queue_summary(p_campaign_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_authenticated_app_user(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_candidate_interview_priority(p_score numeric); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_owner_talent_dashboard(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_talent_public_stats(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION guard_agency_company_user_access(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION guard_company_agency_access(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION guard_platform_user_roles(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION guard_users_security(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION handle_new_talent_candidate(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_agency_user(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_company_user(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_current_platform_user(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_platform_user(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION launch_ai_interview_campaign(p_campaign_id uuid, p_app_base_url text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION legacy_app_login(p_email text, p_password text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION list_manageable_app_users(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION log_system_activity(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION next_request_no(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION publish_ai_interview_template_version(p_template_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION queue_ai_interview_analysis(p_session_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION refresh_ai_interview_campaign_counts(p_campaign_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION remove_candidates_from_ai_interview_campaign(p_campaign_id uuid, p_campaign_candidate_ids uuid[]); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION revalidate_ai_interview_campaign_candidates(p_campaign_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION set_ai_interview_campaign_updated_at(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION set_ai_interview_updated_at(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION set_onboarding_validations_updated_at(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION sync_ai_interview_session_to_campaign(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION talent_after_candidate_profile_change(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION talent_after_profile_change(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION talent_calculate_profile_completeness(p_candidate_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION talent_guard_managed_fields(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION talent_is_privileged_actor(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION talent_refresh_profile_completeness(p_candidate_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION talent_set_updated_at(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION trg_refresh_ai_interview_campaign_counts(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agency_agreements; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agency_client_access; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agency_company_user_access; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agency_members; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agency_penalties; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agency_score_history; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agency_scores; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_agent_action_locks; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_agent_audit_logs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_agent_hourly_activity; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_agent_jobs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_agent_settings; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_agent_worker_runs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_answers; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_campaign_candidates; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_campaigns; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_conversation_turns; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_generation_runs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_questions; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_session_events; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_sessions; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_interview_templates; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE candidate_technical_profiles; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE company_agency_access; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE company_agency_users; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE company_email_settings; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE demobilizations; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE demobilizations_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE education_institutions; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE interviews; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE invoice_items_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE invoices_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE local_content_project_targets; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE local_content_project_targets_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE local_content_settings; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE marketplace_deal_workers; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE marketplace_deal_workers_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE marketplace_deals; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE marketplace_deals_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE marketplace_requests_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE mobilizations; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE mobilizations_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE notification_events_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE onboarding_validations; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE platform_clients; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE profession_aliases; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE profession_aliases_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE professions; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE professions_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE request_audit_logs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE request_lines; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE request_no_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE requests_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE system_activity_logs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE system_backups; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE system_restore_requests; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_candidate_certifications; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_candidate_consents; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_candidate_documents; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_candidate_education; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_candidate_events; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE talent_candidate_events_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_candidate_experience; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_candidate_skills; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_candidates; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_cv_analysis_runs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE talent_resume_versions; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE visa_allocations; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE visa_allocations_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE visa_authorizations; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE visa_batch_lines; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE visa_batch_lines_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE visa_batches; Type: ACL; Schema: public; Owner: -
--
...
\unrestrict IMBWV4R24er7Id41ulGSCLDDpgsu9NqGz3KuChn4R8asNycIzC90AQD9dXtBB2f
